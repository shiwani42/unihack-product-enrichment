...
def compare_rows(expected: dict[str, str], actual: dict[str, str], mpn: str) -> GoldenScore:
    mismatches: list[GoldenDiff] = []
    missing: list[str] = []
    extra: list[str] = []
    expected_filled = 0
    ...
    for field, expected_value in expected.items():
        ...
        if actual_value == expected_value:
            ...
            mismatches.append(GoldenDiff(field=field, expected=expected_value, actual=actual_value))
